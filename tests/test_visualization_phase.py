...
from active_learning.phase_diagram import plot_dataset_phase_diagram, plot_phase_diagram
...
def test_dataset_phase_plot_respects_full_parameter_ranges(tmp_path):
    df = pd.DataFrame({
